...
function pictureSaved() { 
	...
	<form action="Complete_check" method="post">
		...
		<div class="col-sm-12" id="scrolabbleDiv" style="border-top: 2px solid black;">
			<div class="col-sm-12">
			...
			<div id="scanData3DisableDiv">
				...
				<div class="col-sm-12" id="mainLine">
					<div class="col-sm-5">
						<div class="col-sm-12">
							...
							<div class="col-sm-6">
							<input class="form-control" id="datepicker" name="sec1_date" placeholder="DD/MM/YYY" type="text" />
							</div>
						</div>
						<div class="col-sm-12">
							...
							<div class="col-sm-6">
								<div class='input-group date' id='timepicker1' style="margin-top:5px;">
									<input type='text' class="form-control"  style="margin-top:0px;"/> <span
										class="input-group-addon" id="watch"> <span
				...
				<div id="scanData5DisableDiv">
					<div class="col-sm-12" id="mainLine">
						<div class="col-sm-5" id="normalFont">I AGREED AND
							UNDERSTAND THE COMMUNICATION PROCEDURE</div>
						<div class="col-sm-7">
							<div class="col-sm-6">
								<div class="col-sm-4">
									<label class="radio-inline"> <input type="radio"
...
<div class="col-sm-4">
					...
					<div class="col-sm-7">
						<div class="col-sm-6">
							...
							<div class="col-sm-6" style="margin-top:5px;">
								<input class="form-control" style="margin-top:0px;" id="datepicker" name="sec3_from_date"
						...
						<div class="col-sm-6">
							...
							<div class="col-sm-6">
								<div class='input-group date' style="margin-top:5px;" id='timepicker2'>
									<input type='text' class="form-control" style="margin-top:0px;"/> <span
										class="input-group-addon" id="watch"> <span
										class="glyphicon glyphicon-time"></span>
									</span>
				...
				<div class="col-sm-12" id="mainLine">
					<div class="col-sm-7" id="normalFont">PERSON ENTERING IN
						SPACE</div>
				</div>
				...
				<div class="col-sm-12" id="repeateDivButton">
					<div onmouseover=scan2TestinButtonHoverforPlus("scanData9","plus1"); 
				...
				<div class="col-sm-12" id="sectiolDiv">
					...
					<div id="scanData11DisableDiv">
						<div class="col-sm-12 " id="mainLine">
							...
							<div class="col-sm-6" id="normalFont">HYDROCARBON</div>
							<div class="col-sm-4">
								<input type="number" name="sec4_hydro"
									class="form-control" id="scanData3Entry2" >
							</div>
			...
			<div class="col-sm-12" id="repeatGasButton">
				<div onmouseover=scan2TestinButtonHoverforPlus("scanData11","plusButton");
				...
				<div class="col-sm-12" id="mainLine">
					...
					<div class="col-sm-7">
						...
						<div class="col-sm-6">
							...
							<div class="col-sm-4">
								<button type="button" id="commentButton12" 
								onclick=addComment("commentButton12");  class="iconButton">
									<img src="images/commenticon.png" id="scanImage" />
								</button>
							</div>
							<div class="col-sm-4">
...
<div id="myModal" class="modal" >
  <div class="modal-content"style="background-color:#D8CCCC;" >
    ...
    <center><p style="font-weight:bold; font-size:20px">ADD YOUR COMMENT</p></center>
    <center style="margin:20px;"><textarea rows="5" cols="35" style="resize:none;font-size:30px" id="popupText"></textarea></center>
	<center><button type="button" onclick="closePopup()" class="btn btn-success btn-block">Submit</button></center>
  </div>
</div>
<script>
